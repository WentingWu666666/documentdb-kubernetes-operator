...
# DOCUMENTDB_VERSION="0.117.0"      # Database image version (matches values.yaml documentDbVersion)
...
install_documentdb_operator() {
    ...
    #   --set documentDbVersion=${DOCUMENTDB_VERSION}          # Pin database image version (e.g., 0.117.0)
